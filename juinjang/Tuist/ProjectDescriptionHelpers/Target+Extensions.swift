...
extension Target {
    public static func makeTarget(
        ...
        return .target(
            ...
            product: product,
            productName: productName ??  "\(module.moduleName)\(module.moduleSubName)",
            bundleId: bundleId ?? "com.juinjangteam.juinjang.\(module.moduleName.lowercased()).\(module.moduleSubName)",
            deploymentTargets: Environment.deploymentTarget,
            infoPlist: infoPlist,
            sources: sources ?? ["\(module.moduleSubName)/**"],
            resources: resources,
