...
public extension AppTargetType {
    ...
    var storeKitFilePaths: String {
        return "Sources/Manager/InAppPurchase/Products.storekit"
    }
    
    var entitlementsPath: Path {
        return .relativeToRoot("Projects/App/Entitlements/juinjang.entitlements")
    }
