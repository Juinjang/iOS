...
final class PurchasedPencilView: BaseView {
    lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: configureCollectionViewLayout())
    private let emptyPencilView = EmptyPencilView(description: "아직 구매한 연필이 없어요").then {
        $0.isHidden = true
    }
    ...
    override func configureView() {
        collectionView.register(PurchasedPencilCell.self)
